...
function main()
    ...
    large_itemsets_to_file(res, "chess_apriori.txt") 
    res = apriori_tree(database, min_sup) 
    ...
    large_itemsets_to_file(res, "mushrooms_apriori.txt") 
    res = apriori_tree(database, min_sup) 
    ...
    large_itemsets_to_file(res, "retail_apriori.txt") 
    res = apriori_tree(database, min_sup) 
    ...
    res = apriori(database, min_sup) 
    large_itemsets_to_file(res, "groceries_apriori.txt") 
    res = apriori_tree(database, min_sup)
